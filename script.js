...
function WriteLinks(IDtoWrite) {
	...
	WLlinks = WLlinks + WriteOneLink("https://www.gandi.net/whois/details/?search=","",DomName,"registered","Whois (gandi)")
	...
	WLlinks = WLlinks + WriteOneLink("https://toolbox.googleapps.com/apps/checkmx/check?domain=","",DomName,"google","MX Toolbox (gSuite only)")
